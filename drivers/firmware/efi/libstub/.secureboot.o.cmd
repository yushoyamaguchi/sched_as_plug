cmd_drivers/firmware/efi/libstub/secureboot.o := gcc -Wp,-MMD,drivers/firmware/efi/libstub/.secureboot.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/8/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -mcmodel=small -m64 -D__KERNEL__ -fPIC -fno-strict-aliasing -mno-red-zone -mno-mmx -mno-sse -fshort-wchar -Wno-pointer-sign -fno-asynchronous-unwind-tables -Os -DDISABLE_BRANCH_PROFILING -include ./include/linux/hidden.h -D__NO_FORTIFY -ffreestanding -fno-stack-protector -D__DISABLE_EXPORTS   -fplugin=/usr/lib64/gcc-python-plugin/python.so -fplugin-arg-python-script=/work5/scheduler/working//collect.py -fplugin-arg-python-tmpdir=/work5/scheduler/working/ -DKBUILD_MODFILE='"drivers/firmware/efi/libstub/secureboot"' -DKBUILD_BASENAME='"secureboot"' -DKBUILD_MODNAME='"secureboot"' -c -o drivers/firmware/efi/libstub/secureboot.o drivers/firmware/efi/libstub/secureboot.c
