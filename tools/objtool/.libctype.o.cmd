cmd_/work5/scheduler/tools/objtool/libctype.o := gcc -Wp,-MD,/work5/scheduler/tools/objtool/.libctype.o.d -Wp,-MT,/work5/scheduler/tools/objtool/libctype.o -Werror -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wshadow -Wno-switch-default -Wno-switch-enum -Wno-packed -Wno-nested-externs -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -g -I/work5/scheduler/tools/include -I/work5/scheduler/tools/arch/x86/include/uapi -I/work5/scheduler/tools/arch/x86/include -I/work5/scheduler/tools/objtool/arch/x86/include -DINSN_USE_ORC -I/work5/scheduler/tools/lib -D"BUILD_STR(s)=$(pound)s" -c -o /work5/scheduler/tools/objtool/libctype.o ../lib/ctype.c

source_/work5/scheduler/tools/objtool/libctype.o := ../lib/ctype.c

deps_/work5/scheduler/tools/objtool/libctype.o := \
  /usr/include/stdc-predef.h \
  /work5/scheduler/tools/include/linux/ctype.h \
...
/work5/scheduler/tools/objtool/libctype.o: $(deps_/work5/scheduler/tools/objtool/libctype.o)
